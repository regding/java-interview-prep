...
[⬅️ 上一章](28-architecture-patterns.md) · [📖 返回目录](README.md) · [➡️ 下一章](30-data-api-design.md)
# 29 · 可观测性与 SRE 实践（资深向）
...
> 💡 初学者一句话：SLA 是「对客户赔多少」，SLO 是「给自己定多高」，SLI 是「拿什么尺子量」；Error Budget 是「这个月还允许坏多久」——预算烧完就冻结新功能、专心修稳定性。
